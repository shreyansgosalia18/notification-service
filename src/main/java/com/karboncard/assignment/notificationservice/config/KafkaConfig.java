...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topics.sms}")
    private String smsTopic;

    @Value("${spring.kafka.topics.push}")
    private String pushTopic;

    @Value("${spring.kafka.topics.partition-count:3}")
    ...
    public NewTopic emailTopic() {
        return new NewTopic(emailTopic, partitionCount, replicationFactor);
    }
    ...
    public NewTopic pushTopic() {
        return new NewTopic(pushTopic, partitionCount, replicationFactor);
    }
